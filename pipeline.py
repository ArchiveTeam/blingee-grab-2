...
class WgetArgs(object):
    def realize(self, item):
        wget_args = [
            ...
            "--warc-header", ItemInterpolation("blingee-user: %(item_name)s"),
        ]
...
project = Project(
    title="toshiba",
    project_html="""
        <img class="project-logo" alt="Project logo" src="http://archiveteam.org/images/7/73/ToshibaLogo.png" height="50px" title=""/>
        <h2>support.toshiba.com <span class="links"><a href="http://support.toshiba.com/">Website</a> &middot; <a href="http://tracker.archiveteam.org/toshiba/">Leaderboard</a></span></h2>
        <p>Saving download from Toshiba!</p>
    """
)
